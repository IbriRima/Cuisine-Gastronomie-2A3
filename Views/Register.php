            ...
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auto-form-wrapper">
                ...
                method="POST">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="numero" id="numero" placeholder="Numéro de téléphone">
                      <div class="input-group-append">
                        <span class="input-group-text">
                          <i class="mdi mdi-check-circle-outline"></i>
                        </span>
                  ...
                  <!-- <span class="datepicker-toggle"  >
                        ...
                        <label for="start" style="  color: #495057;   font-weight: 400; font-size: small;
                        padding-right: 5ch; padding-left: 2ch;
                        ">Date de naissance</label>
                        <input type="date" class="datepicker-input" id="birthdate" name="birthdate" value=""
                             min="1940-01-01" max="2005-12-31" style="color: #495057;">
                  </span>
                    -->


                  <!-- <div style="padding-left: 8ch; padding-top: 2ch;">
                    <input type="radio" id="homme" name="sexe" value="homme" >
                    <label for="homme" style="color: #495057;   font-weight: 400; font-size: medium;
                    padding-right: 2ch;
                    ">
                    Homme</label>
          
                    <input type="radio" id="femme" name="sexe" value="femme">
                    <label for="femme" style="color: #495057;   font-weight: 400; font-size: medium;
                    ">
                      Femme</label>
                  </div> -->
                  ...
                  <div class="form-group">
                    ...
                    <label id="labelmdp1" name="labelmdp1" style="color:#eb1212">  </label>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <label id="labelmdp2" name="labelmdp2" style="color:#eb1212">  </label>
                  </div>
                  ...
                  <div class="form-group">
                    <button Type="submit" name="submit" class="btn btn-primary submit-btn btn-block"  
                    >S'inscrire</button>
                  </div>
